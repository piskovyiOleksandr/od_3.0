			...
			<div class="slides">
				...
				<div class="story_wrapp">
					<div class="story">
						...
						<video id="video-<?= $item['id'] ?>" paused="true" @if( Cookie::get('video-muted')==='true' )<?php echo 'muted' ?>@endif onTimeUpdate="video_progress('<?= $item['id'] ?>')" ended="" poster="" onloadeddata="init_stories_video_duration(this)">
							<source src="<?= $item['src'] ?>" type="video/mp4" codecs="avc1.42E01E, mp4a.40.2">
						</video>
						<div class="controls">
