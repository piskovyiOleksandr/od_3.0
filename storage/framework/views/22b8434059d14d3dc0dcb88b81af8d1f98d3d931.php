	...
	<div class="settings-content">
		...
		<div class="settigs-nav-block">
			<div class="usr-settings">
				<div class="usr-block">
					<div class="usr-pic">
						<img class="usrPhoto" src="<?php echo e(asset('/images/user_guest.png')); ?>">
		...
		<div class="tab-settings-content">
			<div class="tab-content profile active">
				...
				<div class="universal-input-wrap">
					<input class="universal-input user-nick" type='text'>
					<label class="universal-input-label" alt='Nickname' placeholder='Nickname'></label>
				...
				<div class="universal-input-wrap">
					<input class="universal-input user-age" type='text'>
					<label class="universal-input-label" alt='Age' placeholder='Age'></label>
					<div class="icon icon-input-delete"></div>
					<div class="err-msg">Error message</div>
				</div>

				<div class="universal-input-wrap">
					<input class="universal-input user-language" type='text'>
					<label class="universal-input-label" alt='Language' placeholder='Language'>
					</label>
			...
			<div class="tab-content security">
				...
				<div class="universal-input-wrap">
					<input class="universal-input" required='' type='email'>
					<label class="universal-input-label" alt='Email' placeholder='Email'></label>
					<div class="err-msg">Error message</div>
				</div>

				<div class="universal-input-wrap">
					<input class="universal-input" type='text'>
					<label class="universal-input-label" alt='New password' placeholder='New password'></label>
					<div class="icon icon-input-delete"></div>
					<div class="err-msg">Error message</div>
				</div>
				...
				<div class="universal-input-wrap">
					<input class="universal-input" type='text'>
					<label class="universal-input-label" alt='Repead password' placeholder='Repead password'>
					</label>
					<div class="icon icon-input-edit"></div>
					<div class="err-msg">Error message</div>
				</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\_aproachX\OD_3.0_mix\resources\views/settings.blade.php ENDPATH**/ ?>