	...
	<div class="notifications-popup">
		<div class="notifications_wrapper">
			<div class="avatar">
				<img src="/images/profile/624337ba0ed033.36012964.jpg">
			</div>
...
<script src="<?php echo e(asset('/js/matches.js')); ?>" type="text/javascript" defer></script>
...
<?php echo $__env->make('layout/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\_aproachX\OD_3.0_all\OD_3.0_mix_dev_swiper\resources\views/matches_page/matches.blade.php ENDPATH**/ ?>