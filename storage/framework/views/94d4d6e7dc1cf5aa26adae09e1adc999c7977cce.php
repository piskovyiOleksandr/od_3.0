			...
			<div class="swiper-slide">
				<div class="story_wrapp">
					<div class="story">
						...
						<video id="video-<?= $value['id'] ?>"controls paused="true" <?php if( Cookie::get('video-muted')==='true' ): ?><?php echo 'muted' ?> <?php endif; ?> onTimeUpdate="video_progress('<?= $value['id'] ?>')" poster="" ended="" onloadeddata="init_stories_video_duration(this)">
...
<?php /**PATH E:\_aproachX\OD_3.0_all\OD_3.0_mix_dev_swiper\resources\views/ajax-chat-stories-modal.blade.php ENDPATH**/ ?>