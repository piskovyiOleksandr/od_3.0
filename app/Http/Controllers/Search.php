...
//echo  Session::get('big-city');
		...
		return view( 'search-nearby_page/search', [ 'profiles' => $items, 'filter_goal' => $filter_goal, 'filter_type' => $filter_type, 'remain' => $remain, 'min_max_age_overall' => $min_max_age_overall ] );
	}
