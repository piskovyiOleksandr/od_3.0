...
class Matches extends Controller
{
	...
	public function index()
	{
		...
		return view('matches_page/matches');
	}
	...
	public function find_matches()
	{
		...
		return view('find-matches_page/find-matches', ['profiles' => $items, 'filter_goal' => $filter_goal, 'filter_type' => $filter_type, /* 'remain' => $remain, */ 'min_max_age_overall' => $min_max_age_overall]);
	}
