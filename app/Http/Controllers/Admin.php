...
class Admin extends Controller
{
	...
	public function profile_list()
	{
		...
		return view( 'admin/admin-profiles', [ 'profiles' => $profiles ] );
	}
	...
	public function profile_save()
	{
		...
		return view( 'admin/admin-ajax-profile-save', [
			'profile' => $profile,
			'arGoal' => $arGoal,
			'arType' => $arType,
			'filter_goal' => $filter_goal,
	...
	public function profile_file_del()
	{
		...
		return view( 'admin/admin-ajax-profile-photo-add', [ 'type' => $type, 'chat' => $chat, 'imgs' => $imgs, 'stories' => $stories ] );
	}
	...
	public function profile_file_add()
	{
		...
		return view( 'admin/admin-ajax-profile-photo-add', [ 'chat' => $chat, 'imgs' => $imgs, 'stories' => $stories, 'type' => $type ] );
	}
